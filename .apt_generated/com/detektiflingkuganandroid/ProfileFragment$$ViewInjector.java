...
public class ProfileFragment$$ViewInjector {
  public static void inject(Finder finder, final com.detektiflingkuganandroid.ProfileFragment target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131427385, "field 'buttonFollow' and method 'follow'");
    ...
    view = finder.findRequiredView(source, 2131427382, "field 'textViewStatus'");
    target.textViewStatus = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131427371, "field 'imageViewProfile' and method 'onClickImageViewProfile'");
    ...
    view = finder.findRequiredView(source, 2131427387, "field 'imageButtonEditStatus' and method 'onClickEditStatus'");
    ...
    view = finder.findRequiredView(source, 2131427390, "field 'gridViewLaporan'");
    target.gridViewLaporan = (android.widget.GridView) view;
    view = finder.findRequiredView(source, 2131427388, "field 'buttonFollower' and method 'onClickFollower'");
    ...
    view = finder.findRequiredView(source, 2131427389, "field 'buttonFollowing' and method 'onClickFollowing'");
    ...
    view = finder.findRequiredView(source, 2131427372, "field 'textViewName'");
