...
public class MapFragment extends Fragment{
	...
	private void initialComponent(){
		List<LaporanHelper> listLaporan = DataSingleton.getInstance().getListDataLaporan();
		for (Laporan laporan : listLaporan) {
			MarkerOptions mo = new MarkerOptions();
			mo.position(new LatLng(laporan.getLatitude(), laporan.getLongitude()));
			mo.title(laporan.getDataLaporan());
			mo.snippet("" + laporan.getLongitude() + ", " + laporan.getLatitude());
			map.addMarker(mo);
		}
	}
